          ...
          <div className="flex items-center px-10 py-10 my-20 lg:px-0 lg:pr-10 xl:pl-10">
            <div className="justify-items-center">
              ...
              <p className="text-center lg:text-left xl:pr-14">
                ICT Combiner adalah perusahaan pengembangan web yang berlokasi
                di Bandung, Jawa Barat. Kami memiliki pengalaman bertahun-tahun
                dalam layanan pengembangan web maupun aplikasi mobile. Kami
                memiliki catatan yang terbukti dalam memberikan solusi aplikasi
                web yang kompleks, mulai dari perencanaan, desain, pengerjaan
                hingga pemeliharaan.
              </p>
            </div>
          </div>
